    ...
    if (value === 1){
        ...
        <div className="blogPost">
            <p>Hi everyone!
                <br></br>
                <br></br>
Here is the first update email about my life in China. This update is being sent to all different kinds of people in my life: 
        ...
        html = 
            ...
            <br></br>
            <br></br>
            At 2pm I met up with a person from my company and five other teachers also giving demo lessons. It turns out we were interviewing at a school group which owned a bunch of public schools in the area. When we got there they had us sit in a classroom together. One by one they took us into a new room for the demo, of course, I was picked first. In the room they gave me a sheet of paper with some vocabulary words on it like “bank”, “grocery store”, and “living room”. They told me that I had 15 minutes to create an 8-minute demo lesson for a middle school aged class. Great. Time to use my improv skills I guess. They watched me write a lesson plan in a classroom like hawks, so I couldn’t just whip out my phone and look up sample lesson plans. 
            <br></br>
            <br></br>
            I decided to structure my lesson just like a sample lesson I had watched online the night before, but tailored it to locations in a house rather than the topic the online one had, sports. I can’t quite remember what my lesson entailed as this was a few weeks ago now, but I remember walking into the classroom, realizing that I was teaching the lesson to 6 teachers instead of a classroom of kids, and scrapped the majority of what I had planned as it wouldn’t work without a full classroom of children. After a painful 5 minutes, I ended my lesson on “rooms of the house”. The only comment I got was that I didn’t use the full time. Fingers crossed!
            <br></br>
            <br></br>
			I didn’t hear anything until Monday morning, when I got a text saying that they want to hire me for one of their schools and that I had to go see the school that morning. A small win, but now the real test began. 
            <br></br>
            <br></br>
            I was to teach 3rd-5th grade at a school 20 minutes by bus from my apartment called Lilin primary school. I went that afternoon and met some of the teachers there. Everyone seemed really nice and excited to have an American as part of their staff. Work began the next day for me, meaning I had one evening to prepare three different lesson plans, one for each grade. I asked them for a syllabus, which they didn’t have. So, I asked them if there were textbooks they wanted me to use, which there weren’t. Teaching materials were up to me to decide as well. Great. 
            <br></br>
            <br></br>
            Sitting at home that night I racked my brain for what a good first lesson would be for kids in each age group. With an open canvas and no direction it was incredibly difficult to pick a topic. It didn’t help that my VPN wasn’t working either so browsing the internet for ideas wasn’t really an option. I turned to some of the other foreign teachers for advice and a guy named Sam sent me the lesson plan he made, a true hero. I decided to just use it for all three grades and call it a night. I had no idea what skill level these kids would be at, so without a point of reference I decided to see what would happen.
            <br></br>
            <br></br>
...
In Shenzhen we took them to the standard spots (Electronics market, Baishizhou, Luohu fake goods mall, Dongmen walking street) as well as some things we hadn’t done before. One night we met up with a couple of our Chinese friends and went to a really cool jazz bar that they showed us. We followed up with more music and went to a massive building dedicated to ktv (karaoke). We got a room and spent the next couple hours trading between singing American and Chinese pop songs. I unfortunately had to taxi back home afterwards as I was teaching the next day, but they went off to get late night barbecue. It was a great last night in Shenzhen with friends, and I now have excellent blackmail material of my friends singing (screaming) Ariana Grande songs. </p>
			...
			<figure className="blogFigure">
				<img src="../../blogimages/ktv.jpeg" alt="ktv" height="400em" width="300em" className="blogImage"/> 
				<figcaption className="blogCaption">Image 2: Colin belts karaoke.
				</figcaption>
			</figure>
...
Fajitas!
			...
			<figure className="blogFigure">
				<img src="../../blogimages/guangzhoudimsum.jpeg" alt="dim sum" height="300em" width="400em" className="blogImage"/> 
				<figcaption className="blogCaption">Image 3: Post-dim sum smiles.
				</figcaption>
			</figure>
...
<p>
The past couple of months I’ve been in Shenzhen, I’ve tried to do some nuanced activities that might give me more insight into the culture. For example, there is an Internet cafe near my apartment that I’ve never been in but am always curious what it’s like. One afternoon after teaching I went inside and saw tons of computers lined up in rows with huge monitors, oversized headphones, bright LED keyboards and mouses (mice? What’s the plural form for a computer mouse? I’m just gonna go with mouses) and big black comfy chairs. Most of the seats were taken up by guys in their mid-20s to mid-30s, all chain-smoking cigarettes or eating instant ramen and playing computer games that all looked the same to me. I asked the woman at the front desk if I could use a computer for an hour, and she returned my question with a look of pure confusion. Either she had never seen a foreigner in that cafe, or I totally could have just messed up my question in Chinese. 
<br></br> 
<br></br>
